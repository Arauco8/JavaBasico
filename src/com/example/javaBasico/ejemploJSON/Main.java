package com.example.javaBasico.ejemploJSON;
...
public class Main {
    public static void main(String []args) {
        ...
        try {
            ...
            InputStream is = new FileInputStream("src\\com\\example\\datos.json");

            // Creamos un tokenizador que leera desde nuestro IS (va leyendo caracter a caracter y te va diciendo que es)
